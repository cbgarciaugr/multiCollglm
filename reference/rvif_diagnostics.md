...
left unchanged by this step). Unlike the classical VIF, the RVIF is able
to detect both essential collinearity (near-linear relationships among
...
also decomposes, for each variable, the percentage of near collinearity
